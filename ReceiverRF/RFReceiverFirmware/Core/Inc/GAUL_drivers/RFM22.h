...
typedef struct
{
	SPI_HandleTypeDef *SPIx;   /** Pointer to the SPI handle */
	GPIO_TypeDef *cs_port;	   /** Pointer to the chip select GPIO port */
	uint16_t cs_pin;		   /** Chip select GPIO pin */
	GPIO_TypeDef *snd_port;	   /** Pointer to the shutdown GPIO port */
	uint16_t snd_pin;		   /** Shutdown GPIO pin */
	GPIO_TypeDef *nirq_port;   /** Pointer to the interrupt GPIO port */
	uint16_t nirq_pin;		   /** Interrupt GPIO pin */
	GPIO_TypeDef *gpio_port_1; /** Pointer to the first general-purpose GPIO port */
	uint16_t gpio_pin_1;	   /** First general-purpose GPIO pin */
	GPIO_TypeDef *gpio_port_2; /** Pointer to the second general-purpose GPIO port */
	uint16_t gpio_pin_2;	   /** Second general-purpose GPIO pin */
	GPIO_TypeDef *gpio_port_3; /** Pointer to the third general-purpose GPIO port */
	uint16_t gpio_pin_3;	   /** Third general-purpose GPIO pin */

	// TODO: ajouter channels/fréquence
} RFM22;
...
void RFM22_set_frequency(RFM22 *rfm, const double frequency);

//TODO: ajouter config mode, config fréquence, read, write, auto-tx
